...
pub fn execute(args: &[String]) -> i32 {
    ...
    match shell.as_str() {
        "pwsh" | "powershell" => {
            println!(
                r#"# Naner / rusty_term OSC 133 PowerShell Shell Integration
function prompt {{
    $lastExit = $?
...
"#
        ...
        "bash" => {
            println!(
                r#"# Naner / rusty_term OSC 133 Bash Shell Integration
...
"#
        ...
        "zsh" => {
            print!(
                "# Naner / rusty_term OSC 133 Zsh Shell Integration
precmd() {{
    local exit_code=\"$?\"
    printf \"\\033]133;D;%d\\007\" \"$exit_code\"
    printf \"\\033]133;A\\007\"
...
"
        ...
        "fish" => {
            println!(
                r#"# Naner / rusty_term OSC 133 Fish Shell Integration
